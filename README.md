...
Semantic HTML is a way for you to give meaning to the structure of the web page, it is also a way to help other developers know what goes where on the webpage

2. Name two big differences between ```display: block;``` and ```display: inline;```.

An inline element only takes up as much space as necessary
A block level element takes up the full width of the screen reaching as far as it can go left and right.
